...
typedef enum _EventNotificationClass
    ...
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_3,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_4,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_5,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_6,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_7,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_8,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_9,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_0,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_HYPHEN,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_EQUALS,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_BACKSPACE,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_TAB,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_Q,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_W,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_E,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_R,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_T,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_Y,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_U,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_I,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_O,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_P,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_LEFT_BRACKET,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_RIGHT_BRACKET,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_ENTER,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_CTRL,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_A,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_S,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_D,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_G,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_H,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_J,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_K,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_L,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_SEMI_COLON,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_APOSTROPHE,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_BACK_QUOTE,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_LEFT_SHIFT,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_BACKSLASH,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_Z,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_X,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_C,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_V,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_B,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_N,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_M,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_COMMA,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_PERIOD,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_FORWARD_SLASH,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_RIGHT_SHIFT,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_PRINT_SCREEN,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_ALT,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_SPACE,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_CAPSLOCK,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F1,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F2,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F3,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F4,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F5,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F6,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F7,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F8,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F9,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_F10,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_NUMLOCK,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_SCROLL_LOCK,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_HOME,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_UP,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_PAGE_UP,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_MINUS,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_LEFT,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_CENTER,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_RIGHT,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_PLUS,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_END,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_DOWN,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_PAGE_DOWN,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_INSERT,
    EVENT_NOTIFICATION_KEYBOARD_KEY_CHANGED_DELETE,
    /* count */
